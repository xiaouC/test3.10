...
UsernameIndexing = UniqueIndexing('index_u_username', settings.REDISES['index'])

User.set_identity_generator(RedisIdentityGenerator(pool=settings.REDISES['identity'], key='identity_user'))
